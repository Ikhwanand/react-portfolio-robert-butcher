...
/**
 * A functional component that renders the achievement section of the portfolio.
 *
 * The achievement section contains a heading, a video, and a description of the
 * achievement. The section is animated on entry using framer-motion.
 *
 * @return {JSX.Element} The achievement section component.
 */
    ...
    <div id="award">
      ...
      className="mx-auto flex max-w-6xl flex-wrap">
        ...
        className="w-full p-4 text-center sm:w-1/2">
          ...
          <span
            className="mt-4 border-b border-yellow-400 py-2 text-xl
                font-semibold uppercase text-yellow-400"
          >
            {ACHIEVEMENT.award}
          </span>
